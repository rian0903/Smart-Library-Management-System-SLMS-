...
const defaultNotifications: Notification[] = [
  ...
  },
  {
    ...
    message: 'Anggota Rahmat Hidayat (ANG-00001) mengajukan reservasi online untuk buku "Biologi Molekuler untuk Pemula".',
    time: '12 menit lalu',
    date: '2026-06-24',
    read: false,
    color: '#3B82F6'
  },
  {
    ...
    message: 'Buku "Bumi Manusia" (BKN-012) telah sukses dikembalikan oleh anggota Siti Aminah (ANG-00002). Peminjaman ditutup tanpa denda.',
    time: '1 jam lalu',
    date: '2026-06-24',
    read: true,
    color: '#22C55E'
  ...
  },
  {
    ...
    message: 'Nurul Izzah telah menyelesaikan pendaftaran online. Kode anggota ANG-00004 aktif dan siap digunakan.',
    time: '1 hari lalu',
    date: '2026-06-23',
    read: true,
    color: '#3B82F6'
